defmodule WayfinderWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use WayfinderWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint WayfinderWeb.Endpoint
      ...
      import WayfinderWeb.ConnCase
    end
  end

  setup tags do
    Wayfinder.DataCase.setup_sandbox(tags)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Wayfinder.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
